    ...
    <div class="col">
      <div class="card shadow">
        ...
        <div class="card-body" style="background: #f7f8f9;">
            <form action="{{ route('bookings.update', $booking->id) }}" id="formTable" method="POST">
            @csrf
            @method('put')
            <div class="row">
                <div class="col-6 p-1">
                ...
                <div class="col-md-6 p-1">
                    <div class="form-group">
                        ...
                        <input type="text" name="table" value="{{ $booking->table }}" class="form-control form-control-alternative" placeholder="Nomer Table">
                    </div>
                </div>
