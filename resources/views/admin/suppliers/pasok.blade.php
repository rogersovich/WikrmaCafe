            ...
            <div class="row">
                ...
                <div class="col-md-4 p-1">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" disabled value="{{ ucwords($p['name'].' - '.$p['category']) }}" class="form-control form-control-alternative">
                    </div>
                </div>
                ...
                <div class="col-md-3 p-1">
                    <div class="form-group">
                        ...
                        <input type="text" name="pasok[{{ $p['id'] }}][purchase_price]" value="{{ $p['harga'] }}" class="form-control form-control-alternative">
                    </div>
                </div>
                 <div class="col-md-3 p-1">
                    <div class="form-group">
