                      ...
                      <div class="dropdown">
                        ...
                        <div style="min-width: 6rem;" class="dropdown-menu dropdown-menu-left dropdown-menu-arrow">
                            <div class="dropdown-item">
                                <a href="{{ route('roles.edit', $d->id) }}" class="badge badge-pill badge-success">
                                    Edit
                                </a>
                            </div>
                            <div class="dropdown-item">
                                <a href="#" data-id="{{ route('roles.destroy', $d->id) }}" class="btn-danger badge badge-pill badge-danger">
                                    Delete
                                </a>
                            </div>
                        </div>
