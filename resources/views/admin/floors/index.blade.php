        ...
        <div class="card-header border-1">
            <div class="row">
                ...
                <div class="col-4 text-right">
                    <a href="{{ route('floors.create') }}" class="btn btn-icon btn-neutral btn-round">
                      ...
                      <div class="dropdown">
                        ...
                        <div style="min-width: 6rem;" class="dropdown-menu dropdown-menu-left dropdown-menu-arrow">
                            <div class="dropdown-item">
                                <a href="{{ route('floors.edit', $d->id) }}" class="badge badge-pill badge-success">
                                    Edit
                                </a>
                            </div>
                            <div class="dropdown-item">
                                <a href="#" data-id="{{ route('floors.destroy', $d->id) }}" class="btn-danger badge badge-pill badge-danger">
                                    Delete
                                </a>
                            </div>
                        </div>
